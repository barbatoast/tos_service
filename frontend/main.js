...
var $author$project$Main$fetchUsers = $elm$http$Http$get(
	{
		expect: A2($elm$http$Http$expectJson, $author$project$Main$GotUsers, $author$project$Main$usersDecoder),
		url: 'http://127.0.0.1:5000/users'
	});
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{error: $elm$core$Maybe$Nothing, users: _List_Nil},
		$author$project$Main$fetchUsers);
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('ToS Agreement Tracker')
					])),
				A2(
				$elm$html$Html$table,
				_List_Nil,
